 ...
 * under the License.
 */
package examples.http.websocketx.client;
 ...
 * Therefore you can either start the WebSocket server from the MapDB.examples
 * by running {@link netty.demos.http.websocketx.server.WebSocketServer}
