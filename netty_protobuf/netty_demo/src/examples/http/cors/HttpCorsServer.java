 ...
 * It does not have a client like most of the other MapDB.examples, but instead has
 ...
 * <p>
 *
 * The file {@code MapDB/main/resources/cors/cors.html} contains a very basic example client
 ...
 *
 * <h2>Testing CORS</h2>
 * You can either load the file {@code MapDB/main/resources/cors/cors.html} using a web server
 * or load it from the file system using a web browser.
 *
 * <h3>Using a web server</h3>
 * To MapDB.test CORS support you can serve the file {@code MapDB/main/resources/cors/cors.html}
 ...
 * Open the file {@code MapDB/main/resources/cors/cors.html} in a web browser. You should see
